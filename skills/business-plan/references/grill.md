...
Stance first, questions second. **One question at a time, each carrying your recommended
answer and the reasoning** — a wrong guess is cheap to correct; a blank intake form is a wasted
turn. Pre-answer everything the repo/doc/context already settles and present it as a default to
flip, not a question. Push back on answers that don't survive contact with the evidence — with
reasoning, once; if the founder overrules with their own reasoning, record it as their call
...
- **"What traction exists today?"** — users, revenue, waitlist, DMs, anything. Zero is an
  acceptable answer; it routes traction to the validation plan instead of padding.
...
## 4. Resources & constraints (the plan must survive these)

- **"Team — who, doing what, how many hours/week?"** Venture ambition on 4 hrs/week gets
  called out, plainly.
- **"Runway — how many months can this get worked on before it must pay?"** Months, not
  dollars, unless they offer dollars.
- **"Capital available or sought?"** Bootstrap: what's investable from savings/revenue.
  Venture: the ask range.
- **"Hard constraints?"** Geography, compliance lines they won't cross, platforms they won't
  build for, work they refuse to do.

## 5. Unfair advantages (the thesis multiplier)

- **"What do you have that a random smart founder doesn't?"** Audience/distribution, domain
...
- **"Will you do sales calls?"** If no and the analysis says the category buys sales-led,
  that conflict goes in the plan's risks, not under the rug.
- **"Which channel could you personally sustain for 90 days — build-in-public, SEO/content,
  community, launches, paid?"** Default: match to demonstrated strength (existing audience →
...
- **"When does the first dollar need to arrive?"** Disciplines scope more than any other
  answer.
