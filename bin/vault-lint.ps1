...
#  13. Invoke-ModeSubjectOrphan      subject-orphan
#  14. Invoke-ModeCheck              check
#
...
# ----------------------------------------------------------------------------
# 13. --subject-orphan - a subject the corpus argues from and never filed
#
...
# ----------------------------------------------------------------------------
# 14. check - pass 3, the note-level checks
#
