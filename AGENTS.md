...
`~/Documents/business/<product-slug>/` — the engagement folder IS the vault, holding research
and outputs alongside it, not a separate item among several. **This repo holds
